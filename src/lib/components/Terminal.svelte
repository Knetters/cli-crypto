      ...
      if (event.key === "Enter") {
        ...
        switch (command) {
          case "add":
            if (isNaN(amount) || !coin) {
              terminalOutput.innerHTML =
                "Invalid command syntax. Usage: add <amount> <coin>";
            } else {
          ...
          case "remove":
            if (!coin) {
              terminalOutput.innerHTML =
                "Invalid command syntax. Usage: remove <coin>";
            } else {
          ...
          case "help":
            terminalOutput.innerHTML =
              "List of commands: - add [amount] [coin] - remove [coin] - clear - reset";
            break;
          default:
...
<section class="terminal">
  ...
  <div class="terminal-content">
    <span class="textart" id="textart"
      ><span class="loading-span">Loading...</span></span
    >
    <p class="intro-text">
      Type <span class="purple">help</span> for a list of commands
    </p>
    <div id="output">
      <!-- Output -->
    </div>
    <p>
      <span class="blue" aria-hidden="true">{username}</span><span
        class="white"
